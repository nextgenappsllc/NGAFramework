...
//    // MARK: GET
//    
//    func getRequestToURLString( urlString:String?, parameters:[NSObject:AnyObject]?, completionBlock:NetworkResponseBlock?, progressUpdateBlock:DataProgressBlock? = nil) {
//        let uString = NGAAPIHandler.composeURLStringFromBaseURL(urlString, parameters: parameters)
//        if let urlRequest = uString?.url?.toMutableRequest() {
...
//    // MARK: delete
//    
//    func deleteRequestToURLString( urlString:String?, parameters:[NSObject:AnyObject]?, completionBlock:NetworkResponseBlock?, progressUpdateBlock:DataProgressBlock? = nil) {
//        let uString = NGAAPIHandler.composeURLStringFromBaseURL(urlString, parameters: parameters)
//        if let urlRequest = uString?.url?.toMutableRequest() {
