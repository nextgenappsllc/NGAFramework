...
//        self.view.addSubview(self.topBar)
    ...
    public func setupButtons() {
        ...
        self.menuButton.addTarget(self, action: "menuButtonPressed", forControlEvents: UIControlEvents.TouchUpInside)
        ...
        self.backButton.addTarget(self, action: "popViewController", forControlEvents: UIControlEvents.TouchUpInside)
        ...
        self.homeButton.addTarget(self, action: "popToRootViewController", forControlEvents: UIControlEvents.TouchUpInside)
